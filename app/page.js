    ...
    <div className="relative min-h-screen w-full bg-white overflow-hidden">
      ...
      <div className="hidden lg:block">
        ...
        <div
          ...
          style={{ width: 'max-content', left: 100, top: 560, transform: 'translateY(-50%)' }}
        >
          <Link href="/discover" className="flex items-center group">
            ...
            <span className="text-xs text-black group-hover: whitespace-nowrap">DISCOVER A.I.</span>
          </Link>
        </div>
        ...
        <div
          ...
          className="absolute z-30 flex items-center"
          style={{ width: 'max-content', right: 100, top: 560, transform: 'translateY(-50%)' }}
        >
          <Link href="/testing" className="flex items-center group">
            <span className="text-xs text-black group-hover: whitespace-nowrap mr-2">TAKE TEST</span>
